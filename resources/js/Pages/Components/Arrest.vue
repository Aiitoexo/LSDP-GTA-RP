<template>
    ...
    <div class="col-span-2 flex justify-around items-center grid grid-cols-2 gap-4">
        <div class="col-span-1 flex justify-center">
            <button v-if="!arrest.fine_remove" @click="this.$emit('active-modal', { modal: 'arrest', type: 'update', data: arrest })"
        ...
        <div class="col-span-1 flex justify-center">
            <button @click="deleteArrest" class="text-white bg-red-500 p-2 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
export default {
    ...
    methods: {
        deleteArrest() {
            axios.post(route('dashboard.destroy.arrest'), {
                arrest_id: this.arrest.id,
                profile_in_mate_id: this.arrest.profile_in_mate_id
            })
            .then(response => {
