<template>
    <div class="h-full flex flex-col">
        ...
        <div class="flex-1 bg-zinc-100 p-2 grid grid-cols-6 shadow-[0_-4px_30px_-5px_rgba(0,0,0,0.3)]">
            <textarea class="col-span-5 resize-none rounded-l-md border-blue-200"></textarea>
